...
section '.code' code readable executable
  ...
  proc MainDlg hdlg, msg, wparam, lparam
    ...
    jmp     .finish
    .wminitdlg:
      invoke  capCreateCaptureWindow, _camtitle, WS_VISIBLE + WS_CHILD, 10, 10, 260, 252, [hdlg], 0
      mov     [hWebcam], eax
      jmp     .finish
    .wmcommand:
...
section '.rsrc' resource data readable
  ...
  dialog        main_dialog, 'Webcam Photo', 0, 0, 190, 200, WS_CAPTION + WS_POPUP + WS_SYSMENU + DS_MODALFRAME + DS_CENTER
